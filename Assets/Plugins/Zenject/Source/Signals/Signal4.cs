...
namespace Zenject
{
    ...
    {
        private readonly List<Action<TParam1, TParam2, TParam3, TParam4>> _listeners = new List<Action<TParam1, TParam2, TParam3, TParam4>>();
#if ZEN_SIGNALS_ADD_UNIRX
        readonly Subject<Tuple<TParam1, TParam2, TParam3, TParam4>> _observable = new Subject<Tuple<TParam1, TParam2, TParam3, TParam4>>();
#endif
        private readonly List<Action<TParam1, TParam2, TParam3, TParam4>> _tempListeners = new List<Action<TParam1, TParam2, TParam3, TParam4>>();
