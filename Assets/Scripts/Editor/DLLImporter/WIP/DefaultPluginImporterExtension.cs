...
{
    public class DefaultPluginImporterExtension : IPluginImporterExtension
    {
        ...
        public class Property
        {
            ...
            internal virtual void Reset(DLLFileWrapperInspector inspector)
            {
                string valueString = inspector.importer.GetPlatformData(platformName, key);
                ParseStringValue(inspector, valueString);
            }

            protected void ParseStringValue(DLLFileWrapperInspector inspector, string valueString, bool muteWarnings = false)
            {
                try
                {
            ...
            internal virtual void Apply(DLLFileWrapperInspector inspector)
            {
            ...
            internal virtual void OnGUI(DLLFileWrapperInspector inspector)
            {
        ...
        public virtual void ResetValues(DLLFileWrapperInspector inspector)
        {
            hasModified = false;
            RefreshProperties(inspector);
        }

        public virtual bool HasModified(DLLFileWrapperInspector inspector)
        {
            return hasModified;
        }

        public virtual void Apply(DLLFileWrapperInspector inspector)
        {
        ...
        public virtual void OnEnable(DLLFileWrapperInspector inspector)
        {
            RefreshProperties(inspector);
        }

        public virtual void OnDisable(DLLFileWrapperInspector inspector)
        {
        }

        public virtual void OnPlatformSettingsGUI(DLLFileWrapperInspector inspector)
        {
        ...
        protected virtual void RefreshProperties(DLLFileWrapperInspector inspector)
        {
            foreach (var p in properties)
            {
                p.Reset(inspector);
