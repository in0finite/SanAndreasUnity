...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    /// </summary>
    public class XCopyColorPass : ScriptableRenderPass
    {
        ...
        const string m_ProfilerTag = "XCopy Color";

        /// <summary>
        /// Create the CopyColorPass
        /// </summary>
        public XCopyColorPass(RenderPassEvent evt, Material samplingMaterial)
        {
