...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    /// </summary>
    public class XCopyDepthPass : ScriptableRenderPass
    {
        private RenderTargetHandle source { get; set; }
        private RenderTargetHandle destination { get; set; }
        Material m_CopyDepthMaterial;
        const string m_ProfilerTag = "XCopy Depth";

        int m_ScaleBiasId = Shader.PropertyToID("_ScaleBiasRT");

        public XCopyDepthPass(RenderPassEvent evt, Material copyDepthMaterial)
        {
