...
- What to do before making a release: don't show minimap label while loading ; change starting pos ; don't load parked vehicles ; add fps-max option, time scale option ;
