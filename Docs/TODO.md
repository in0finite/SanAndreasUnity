...
- **Ped state machine**: rename base class ; improve PlayerController ; add events: OnAimPressed, OnNextWeapon ; rename fire states ; move methods from Weapon to aim state ;
