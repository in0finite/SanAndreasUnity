...
namespace Facepunch.ConCommands
{
    ...
    public static class ConCommand
    {
        ...
        private static readonly CommandSet _rootCommand = new CommandSet();
            ...
            foreach (var type in Assembly.GetExecutingAssembly().GetTypes()) {
                foreach (var method in type.GetMethods(BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic)) {
                    ...
                    try {
                        ...
                        _rootCommand.Add(attrib.Prefix, deleg, attrib);
        ...
        public static ConCommandResult Run(Domain domain, String args)
        {
            ...
            try {
                ...
                foreach (var command in commands) {
                    result = new ConCommandResult(_rootCommand.Run(domain, command));
                }
                return result;
